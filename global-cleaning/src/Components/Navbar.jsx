...
const Navbar = () => {
  ...
  const serviceCategories = [
    { id: 'domestic', name: 'Domestic Cleaning', icon: <Home size={16} className="text-white font-bold" /> },
    { id: 'commercial', name: 'Commercial Cleaning', icon: <Briefcase size={16} className="text-white font-bold" /> },
    { id: 'fumigation', name: 'Fumigation & Pest Control', icon: <Bug size={16} className="text-white font-bold" /> },
    { id: 'car', name: 'Car Interior Cleaning', icon: <Car size={16} className="text-white font-bold" /> },
    { id: 'dusting', name: 'Dusting Services', icon: <Wind size={16} className="text-white font-bold" /> },
    { id: 'specialized', name: 'Specialized Services', icon: <Droplets size={16} className="text-white font-bold" /> }
  ];
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center">
            ...
            <div className="ml-2">
              <h1 className="text-2xl font-bold font-libre text-white">GLOBAL CLEANING</h1>
              <p className="text-xs text-white">Cleaning & Fumigation Services</p>
            </div>
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-white font-bold hover:text-accent transition-colors">HOME</Link>
            <Link to="/about" className="text-white hover:text-accent transition-colors font-bold">ABOUT</Link>

            <div className="relative" ref={dropdownRef}>
              <button
                className="flex items-center text-white hover:text-accent transition-colors font-bold"
                onMouseEnter={() => setDropdownOpen(true)}
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                SERVICES <ChevronDown size={16} className="ml-1 text-white" />
              </button>
            ...
            <Link to="/blogs" className="text-white hover:text-accent font-bold transition-colors">BLOGS</Link>
            <Link to="/contact" className="text-white hover:text-accent font-bold transition-colors">CONTACT</Link>
          </div>
