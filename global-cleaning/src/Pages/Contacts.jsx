  ...
  return (
    <div className="bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-primary hover:bg-opacity-90 text-white font-medium py-2 px-6 rounded-md transition duration-200 font-bai"
                  >
                    Send Message
                  </button>
                </div>
        ...
        {/* Map Section */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-primary font-libre mb-6 text-center">Find Us</h2>
          <div className="bg-muted h-64 rounded-lg overflow-hidden shadow-lg">
            {/* Replace with actual map component or iframe */}
            <div className="w-full h-full flex items-center justify-center bg-gray-200">
              <p className="text-gray-600 font-bai">Map integration will be placed here</p>
